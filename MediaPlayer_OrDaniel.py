...
class Player(Tk.Frame):
    ...
    def __init__(self, parent, title=None, video=''):
        ...
        self.text.set("00:00")
        self.timeLabel = Tk.Label(self.buttons_panel, textvariable=self.text)
        self.timeLabel.pack()
    ...
    def _AnchorButtonsPanel(self):
        ...
        panel_x = self.parent.winfo_x() + 7
        panel_y = self.parent.winfo_y() + video_height + 52 # 23 seems to put the panel just below our video.
    ...
    def OnTick(self):
        ...
        if self.player:
            ...
            if t > 0:
                ...
                if t > 0 and time.time() > (self.timeSliderUpdate + 1):
